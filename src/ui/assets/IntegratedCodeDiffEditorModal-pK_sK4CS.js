import{r,j as e}from"./react-vendor-DrROGObh.js";import{F as k,h as T,G as E,X as P,C as j,B as D,S as F}from"./icons-Dmz6A0sF.js";const l=[{name:"Nginx 反向代理配置 (Nginx Config)",path:"/etc/nginx/sites-available/default",content:`server {
    listen 80;
